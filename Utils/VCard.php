...
class VCard {
    ...
    public function addEmail($address, $type = '') {
        $this->setProperty(
                'email', 'EMAIL;INTERNET' . (($type != '') ? ';' . $type : ''), $address
        );
    ...
    $lastName = '', $firstName = '', $additional = '', $prefix = '', $suffix = ''
        ...
        if (!$this->hasProperty('FN')) {
            // set property
            $this->setProperty(
                    'fullname', 'FN', trim(implode(' ', $values))
            );
        }
     ...
     * @return $this
     */
    public function addSkype($username) {
        $this->setProperty(
                'skype', 'X-SKYPE-USERNAME', $username
        );
